package com.cebon.cdjcy.security.token.provider;

import com.cebon.cdjcy.security.token.authentication.JWTAuthenticationToken;
import com.cebon.cdjcy.security.token.exception.TokenExpiredException;
import com.cebon.cdjcy.security.token.exception.TokenMalformationException;
import com.cebon.cdjcy.security.token.service.TokenService;
import com.cebon.cdjcy.user.domain.Role;
import com.cebon.cdjcy.user.domain.User;
import com.cebon.cdjcy.user.dto.RoleDTO;
...
public class RefreshCustomAuthenticationProvider implements AuthenticationProvider {
    ...
    @Value("${cdjcy.auth.refresh_token_expirationminutes}")
    private Long refresh_token_expirationminutes;

    @Value("${cdjcy.auth.token_expirationminutes}")
