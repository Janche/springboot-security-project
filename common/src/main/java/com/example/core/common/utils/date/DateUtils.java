package com.example.core.common.utils.date;
...
public class DateUtils {
    ...
    public static int getIntervalDays(Date date, Date otherDate) {
        int num = -1;
        Date dateTmp = DateUtils.StringToDate(DateUtils.getDate(date), DateStyleEnum.YYYY_MM_DD);
        Date otherDateTmp = DateUtils.StringToDate(DateUtils.getDate(otherDate), DateStyleEnum.YYYY_MM_DD);
